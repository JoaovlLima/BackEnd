...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO funcionario (nome, sobrenome, salario, data_contratacao, cargo, numero_da_agencia, cidade) 
            VALUES (:nome, :sobrenome, :salario, :data_contratacao, :cargo, :numero_da_agencia, :cidade)";
